...
class prediction:
    def __init__(self, data):
        ...
        self.data = data
        self.columns = [ 'LIMIT_BAL', 'SEX', 'EDUCATION', 'MARRIAGE', 'AGE', 'PAY_0' ]
        d = [ 'PAY_2', 'PAY_3', 'PAY_4', 'PAY_5', 'PAY_6', 'BILL_AMT1', 'BILL_AMT2', 'BILL_AMT3', 'BILL_AMT4',
    ...
    def predictionFromModel(self):
        try:
            ...
            file_loader = file_methods.File_Operation(self.file_object, self.log_writter)
            kmeans = file_loader.load_model('Kmeans')
            self.log_writter.log(self.file_object, "Clustering model loaded")
